...
//		employeeInfoDao.deleteById(employeeInfo.getEmployeeCode());
	...
	public void readEmployeeInfoTest() {// test搜尋功能
		...
		System.out.println(employeeInfo.getEmployeeCode() + "  " + employeeInfo.getJoinTime() + "  "
				+ employeeInfo.getEmployeeEmail());
	}

	@Test
	public void updateEmployeeInfo() {// test修改功能

		EmployeeInfoReq employeeInfo = new EmployeeInfoReq("A001", "josh", "E123465987", "D1567@gmail.com", "資訊", 0, 1,
				"正常");
